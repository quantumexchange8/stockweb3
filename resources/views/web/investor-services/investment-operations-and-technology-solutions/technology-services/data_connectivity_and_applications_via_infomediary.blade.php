...
<div class="container">
    ...
    <div class="eleven columns">
        <h2>Data Connectivity & Applications Via Infomediary</h2>
        <p style="padding-top: 10px;">
            ...
            &nbsp;&nbsp;&nbsp;&bull;&nbsp;<a href="javascript:goTo('infoNav')">InfoNAV</a>™: a multi-provider, secondary NAV tool designed for asset managers to oversee NAV production across
