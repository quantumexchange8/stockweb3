...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <p style="padding-top: 10px;">
            @lang('public.fund accounting 1')

            <br><br>
            <strong>@lang('public.fund accounting 2')</strong><br>
            @lang('public.fund accounting 3')
            <br><br>
            <strong>@lang('public.fund accounting 4')</strong><br>
            @lang('public.fund accounting 5')
        </p>
    </div>
