<div class="container breadcrumb">
    <div class="sixteen columns">
        <span>
            ...
            &nbsp;&nbsp;<strong>@lang('public.securities lending')</strong>
        </span>
    </div>
    <br><br>
    <hr>
...
<div class="container">
    ...
    <div class="eleven columns">
        <h2>@lang('public.securities lending')</h2>
        <p style="padding-top: 10px;">
            Vanward specializes in securities lending for asset managers, with approximately 90% of our clients
            ...
            <br>
            Un-encumbered by maintaining a large volume lending program, Vanward is uniquely positioned to execute
            ...
            <br>
            Pre-trade, Vanward offers Securities Lending DealBoard, which enables our clients to see revenue opportunities,
