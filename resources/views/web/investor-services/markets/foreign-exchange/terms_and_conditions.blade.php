...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <p style="padding-top: 10px;">
            ...
            <br><br>
            <strong>1. Settlement Netting.</strong> Unless agreed otherwise in writing by Vanward, any amounts payable by a party to a
            ...
            <br><br>
            <strong>3. Consequences of Termination.</strong> (i) Following termination under Clauses 2 above and 5 below, Vanward shall have
            ...
            <br><br>
            <strong>4. Set-Off.</strong> (i) Vanward shall have a general right of set-off with respect to all amounts owed by you pursuant
            ...
            <br><br>
            <strong>9. Jurisdiction and Governing Law.</strong> This contract and the Transactions between you and Vanward shall be governed
