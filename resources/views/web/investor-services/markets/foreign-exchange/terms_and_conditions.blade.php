...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <p style="padding-top: 10px;">
            ...
            into between Wingate (“WAML”) and a counterparty (“you,” “your”) apply, except to the extent (if any) that
            WAML shall have agreed in writing or notified you in writing otherwise that other or additional terms apply.
            <br><br>
            <strong>1. Settlement Netting.</strong> Unless agreed otherwise in writing by WAML, any amounts payable by a party to a
            ...
            <br><br>
            <strong>2. Events of Default.</strong> (i) Each of the following shall be deemed an event of default (each, an “Event of
            ...
            after notice of such failure from WAML; (b) You, your parent, affiliate or investment manager/advisor (where
            ...
            condition/position or credit rating) which WAML determines in its sole discretion may adversely affect your
            ability to perform your obligations under any Transaction.
            <br><br>
            <strong>3. Consequences of Termination.</strong> (i) Following termination under Clauses 2 above and 5 below, WAML shall have
            the right to close out all outstanding Transactions between you and WAML. WAML will use the methodology set
            ...
            Dollars, the “Determining Party” in the definition of “Close-out Amount” is WAML, and the “Early Termination
            Date” is the effective date of termination under Clauses 2 above and 5 below, as the case may be. (ii) WAML
            ...
            WAML, you will pay to WAML to an account specified by WAML. If the amount is owed to you by WAML, WAML will
            pay the absolute value of the Early Termination Amount to your account. Such payments will be payable on the
            date on which WAML provides the notification under this clause.
            <br><br>
            <strong>4. Set-Off.</strong> (i) WAML shall have a general right of set-off with respect to all amounts owed by you pursuant
            to a Transaction or otherwise, whether due and payable or not, and regardless of whether an Event of Default
            has occurred and/or whether a Transaction has been terminated. (ii) WAML’s rights hereunder shall be in
            addition to, and not in limitation or exclusion of, any rights which WAML may have (by agreement, operation
            of law or otherwise).
            <br><br>
            <strong>5. Force Majeure.</strong> No liability will attach to any party for any losses or damages as a result of a Force
            ...
            <br><br>
            <strong>6. Transaction Instructions, Confirmations and Settlement Instructions.</strong> (i) Transaction instructions may be
            given by you to WAML in such manner and subject to such terms as agreed between the parties from time to
            time. WAML may, without further enquiry, act on, and you shall be bound by, any instruction actually
            received by WAML, which it reasonably believes, in good faith, to have been given by you, or on your behalf.
            (ii) WAML will endeavor to dispatch a confirmation within 24 hours of execution of a Transaction, in such
            manner as agreed between the parties from time to time. Unless you notify WAML prior to settlement with
            reasonable time for WAML to unwind the trade that a confirmation is incorrect or that the Transaction
            described therein was not properly authorized, such Transaction shall be deemed valid and binding on you.
            WAML’s failure for any reason to provide a confirmation shall not invalidate any Transaction executed by
            WAML. (iii) You will provide to WAML a list of the persons designated to receive confirmations from WAML,
            ...
            otherwise by you in writing, WAML shall be entitled to conclusively rely on any such list of designated
            ...
            further acknowledge that the receipt of legible instructions via facsimile cannot be assured, that WAML
            cannot verify that authorized signatures on a facsimile instruction are original or properly affixed.
            Accordingly, you agree not to hold WAML liable for any losses incurred as a consequence of effecting any
            e-mail or facsimile instructions.
            <br><br>
            <strong>7. Electronic Communications.</strong> You consent to the monitoring and recording of all electronic communications
            (including e-mail, voicemail, telephone calls and website usage) between you and WAML and agree (i) to
            ...
            <br><br>
            <strong>8. Assignment, Integration, Qualifying Financial Contract.</strong> No assignment of this contract or any of your
            rights or obligations hereunder shall be made without WAML’s express prior written consent, and any such
            purported assignment or transfer without WAML’s prior written consent shall be of no effect. This contract
            ...
            options between you and WAML constitute one integrated contract (notwithstanding WAML’s right to consider
            ...
            and Uniform Commercial Code and is a final expression of the agreement of WAML and you with respect to the
            Transactions listed on the reverse side hereof.
            <br><br>
            <strong>9. Jurisdiction and Governing Law.</strong> This contract and the Transactions between you and WAML shall be governed
            by, and construed in accordance with, the laws of the State of New York without reference to any choice of
            law rules. WAML and you irrevocably (a) submit to the non-exclusive jurisdiction of the court of the State
            ...
            any such court does not have jurisdiction over WAML or you, as the case may be, (e) waive the right to trial
            by jury in any suit, action or proceeding, and (f) designate the Secretary of State of the State of New York
            as its agent for the service of process (provided that WAML and you may by written notice to the other
            ...
            products and is subject to change without notice. Neither Wingate nor its affiliates accept any
            responsibility for the results or liabilities arising out of the use of this information. All information
            supplied by WAML & Co. is from sources deemed reliable and is furnished subject to errors, omissions,
            ...
            and also agrees that WAML and its affiliates bear no responsibility or liability for such decisions.
        </p>
    </div>
