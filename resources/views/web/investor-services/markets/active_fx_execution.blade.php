...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <p style="padding-top: 10px;">
            ...
            <br><br>
            <strong>Client-focused approach to trading:</strong>
            <br><br>
            &nbsp;&nbsp;&nbsp;&bull;&nbsp;Our trading philosophy focuses on long term relationships and delivering quick, competitive pricing to our
            clients. <br>
            &nbsp;&nbsp;&nbsp;&bull;&nbsp;We offer our clients a single point of contact via sales traders in New York, London, Tokyo and Hong Kong,
            which combined with a centralized trading desk, allows us to provide 24-hour seamless coverage.<br>
            &nbsp;&nbsp;&nbsp;&bull;&nbsp;We are delivery and distribution agnostic permitting clients to connect with us in a variety of ways,
            including directly calling a sales trader or through third party platforms such as Bloomberg, FlexTrade, FXall, or FXConnect.<br>
            <br><br>
            <strong>Backed by Industry Leading Expertise</strong>
            <br><br>
            &nbsp;&nbsp;&nbsp;&bull;&nbsp;We are an industry leading market maker to our clients in major and emerging markets with expertise in the
            asset manager segment, as demonstrated by ranking #1 in the US Greenwich Quality Index Foreign Exchange
            Survey for 18 straight years.<br>
            &nbsp;&nbsp;&nbsp;&bull;&nbsp;Our clients have access to a top tier currency strategy research team that provides commentary on currency,
            economic and geopolitical developments, as well as a dedicated FX emerging markets team who understands the
            complex requirements of emerging markets and how they may apply to global asset managers.<br>
            <br><br><br>

            <span style="font-style: italic;">
                Disclaimer: Using extensive input from dealers, publicly available sources, and their own research,
