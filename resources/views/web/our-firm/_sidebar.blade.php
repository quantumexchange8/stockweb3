...
<div id="sidebar">
    ...
    <hr>
    <ul>
        <li><a href="javascript:goTo('thePartnership')">@lang('public.the partnership')</a></li>
        <li><a href="javascript:goTo('ourMissionAndProfile')">@lang('public.our mission & profile')</a></li>
        <li><a href="javascript:goTo('sustainability')">@lang('public.sustainability')</a></li>
        <li><a href="javascript:goTo('philanthropy')">@lang('public.philanthropy')</a></li>
        <li><a class="title" href="javascript:goTo('policiesAndDisclosures')">@lang('public.policies & disclosures')</a>
            <ul>
                <li><a href="javascript:goTo('importantStatementsAndDisclosures')">@lang('public.important statements & disclosures')</a></li>
                <ul>
                ...
                <li><a href="javascript:goTo('privacyPolicy')">@lang('public.privacy policy')</a></li>
                <ul>
