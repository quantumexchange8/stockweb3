...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <p style="padding-top: 10px;">
            This notice is to make you aware of how the personal data that you provide to Vanward is processed. In this
        ...
        <p style="padding-left: 30px;">
            1. All personal data that you provide to Vanward has been collected, processed and provided to Vanward in
        ...
        <br><br>
        Vanward will process any personal data that you provide in accordance with the GDPR. Vanward has implemented
        ...
        <br>
        Vanward will comply with the GDPR when transferring personal data to a recipient outside of the European
        Economic Area.
        <br>
        <br>
        <br>
        ...
        <br><br>
        Vanward will retain personal data only for as long as is reasonably necessary for the purpose for which it was
        ...
        <br>
        Please address requests to Vanward by email at <a href="mailto:dpo@wgaml.com">dpo@wgaml.com</a>
        <br>
        <br>
        <br>
        This publication is provided by Vanward and its subsidiaries ("Vanward") to recipients, who are classified as
