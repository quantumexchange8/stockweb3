<div class="container breadcrumb">
    <div class="sixteen columns">
        <span>
            ...
            &nbsp;&nbsp;<strong>@lang('public.cookie policy')</strong>
        </span>
    </div>
    <br><br>
    <hr>
...
<div class="container">
    ...
    <div class="eleven columns">
        <h2>@lang('public.cookie policy')</h2>
        ...
        <div class="teaser-text">
            ...
            <p>Vanward and all other related affiliates and subsidiaries (collectively “Vanward”, “we” or “us”)
                ...
                Privacy Policy, which can be found at <a href="../privacy-policy.html"
                    target="_blank">www.wgaml.com/en-us/our-firm/policies-and-disclosures/privacy-policy</a>.
            </p>
            <p><strong>Websites covered by this Cookie Policy</strong></p>
            <p>This Cookie Policy explains how Cookies are used on wgaml.com and other websites operated by
            ...
            <p>This Cookie Policy does not apply to those websites that have their own cookie policy or to
                ...
                for that site.</p>
            <p><strong>What this Cookie Policy covers</strong></p>
            <p>This Cookie Policy covers:</p>
            ...
            <p><em>What are Cookies and similar technologies?</em></p>
            <p>Cookies are text files containing small amounts of information downloaded to your computer or
            ...
            <p>You can choose whether to accept the use of Cookies and similar technologies in general by
                ...
                as intended.</p>
            <p>You can find more information about Cookies and similar technologies at: <a
                    href="https://www.allaboutcookies.org/" class="disclaimer-toggle">www.allaboutcookies.org</a> and <a
                    href="https://www.youronlinechoices.com/" class="disclaimer-toggle">www.youronlinechoices.eu</a>.
            </p>
            <p><em>Who sets Cookies?</em></p>
            <p>Cookies may be set by our Sites or by another site prior to or during your visit to our
            ...
            <p>(1) <strong>Strictly necessary Cookies</strong> - These Cookies are essential in order to
            ...
            <p>We categorize the following Cookie as strictly necessary:&nbsp;</p>
            <div style="padding-left: 30px;">
                <li>Registered Visitor Cookie for INFUSE, our client portal - If a visitor to our Site logs
                    ...
                    operate without this cookie.</li>
            </div>
            <p>(2) <strong>Performance Cookies</strong> - These Cookies collect information about how
                ...
                a site works.</p>
            <p>We categorize the following as performance Cookies:</p>
            <div style="padding-left: 30px;">
                <li>Referrer URL (internal page) - Used to store the URL of the previous page visited.
            ...
            <p><strong>(3) Functionality Cookies </strong>- These Cookies allow a site to remember choices
            ...
            <p>These Cookies cannot track your browsing activity on other websites. They don’t gather any
                information about you that could be used for advertising or remembering where you’ve been on
                the internet outside our site.</p>
            <p>We categorize the following as functionality Cookies:</p>
            <div style="padding-left: 30px;">
                <li>Recently viewed pages - Stores pages visited by the user on our Sites and displays them
            ...
            <p><em>Refusing or Managing Cookies on our Sites</em></p>
            <p>If you want to remove existing Cookies from your device, you can do this using your browser
                ...
                Managing Cookies page or visit the following third party site: <a
                    href="https://www.allaboutcookies.org/manage-cookies/"
                    class="disclaimer-toggle">www.allaboutcookies.org/manage-cookies</a>. Instructions must
                be followed on each browser separately.</p>
            <p>Deleting and blocking Cookies will have an impact on your user experience as parts of the
            ...
            <p>If you have questions or comments about this policy please contact <a
                    href="mailto:globalprivacy@wgaml.com" target="_blank">globalprivacy@wgaml.com</a>.</p>
            <p>&nbsp;</p>
        </div>
        </p>
    </div>
