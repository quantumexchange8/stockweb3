...
@section('content')
    ...
    <div id="about">
        <div class="container">
            ...
            <div class="sixteen columns">
                <p>We're a close team of creatives, designers & developers who work together to create beautiful, engaging
                    digital experiences. We take pride in delivering only the best.</p>
            </div>
        </div>
        <div class="container">
                ...
                <ul class="slider1">
                    <li>
                        <div class="eight columns animated bounceInLeft">
                            <img src="{{ asset('images/office1.gif') }}" alt="" />
                        </div>
                        <div class="eight columns animated bounceInRight">
                            <img src="{{ asset('images/office2.gif') }}" alt="" />
                        </div>
                    </li>
                    <li>
                        <div class="eight columns">
                            <img src="{{ asset('images/office3.gif') }}" alt="" />
                        </div>
                        <div class="eight columns">
                            <img src="{{ asset('images/office4.gif') }}" alt="" />
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <li>
                        <div class="eight columns">
                            <div class="team-wrap">
                                ...
                                <div class="animated bounceIn"><img src="{{ asset('images/team1.png') }}" alt="" /></div>
                        ...
                        <div class="eight columns">
                            <div class="team-wrap">
                                ...
                                <div class="animated bounceIn"><img src="{{ asset('images/team2.png') }}" alt="" /></div>
                    ...
                    <li>
                        <div class="eight columns">
                            <div class="team-wrap">
                                ...
                                <img src="{{ asset('images/team3.png') }}" alt="" />
                        ...
                        <div class="eight columns">
                            <div class="team-wrap">
                                ...
                                <img src="{{ asset('images/team4.png') }}" alt="" />
        ...
        <div id="skills">
            ...
            <div class="container">
                ...
                <div class="eight columns">
                    <ul class="skill">
                        <li class="animated holeIn"><span class="bar bar-prc1"></span>
                            <p>Css</p>
                        </li>
                        <li class="animated holeIn delay"><span class="bar bar-prc2"></span>
                            <p>jQuery</p>
                        </li>
                        <li class="animated holeIn delay1"><span class="bar bar-prc3"></span>
                            <p>Wordpress</p>
                        </li>
                    </ul>
                </div>
                <div class="eight columns">
                    <ul class="skill">
                        <li class="animated holeIn"><span class="bar bar-prc4"></span>
                            <p>Graphic Design</p>
                        </li>
                        <li class="animated holeIn delay"><span class="bar bar-prc5"></span>
                            <p>Html</p>
                        </li>
                        <li class="animated holeIn delay1"><span class="bar bar-prc6"></span>
                            <p>MoTools</p>
                        </li>
                    </ul>
                </div>
        ...
        <div id="services-wrapper">
            <div class="container">
                <div class="four columns">
                    <div class="services-wrap">
                        <div class="services-wrap-icon animated bounceIn delay">
                            <img src="{{ asset('images/ser1.png') }}" alt="" />
                        </div>
                ...
                <div class="four columns">
                    <div class="services-wrap">
                        <div class="services-wrap-icon animated bounceIn">
                            <img src="{{ asset('images/ser2.png') }}" alt="" />
                        </div>
                ...
                <div class="four columns">
                    <div class="services-wrap">
                        <div class="services-wrap-icon animated bounceIn">
                            <img src="{{ asset('images/ser3.png') }}" alt="" />
                        </div>
                        <h6>Search Engine</h6>
                        <p>Class aptent taciti sociosqu ad litora torquent.</p>
                ...
                <div class="four columns">
                    <div class="services-wrap">
                        <div class="services-wrap-icon animated bounceIn delay">
                            <img src="{{ asset('images/ser4.png') }}" alt="" />
                        </div>
                        <h6>Monitoring</h6>
                        <p>Class aptent taciti sociosqu ad litora torquent.</p>
                ...
                <div class="clients-wrap">
                    <ul class="slider4">
                        ...
                        <li>
                            ...
                            <div class="four columns">
                                <img src="{{ asset('images/logo/6.png') }}" alt="" />
                            </div>
                            <div class="four columns">
                                <img src="{{ asset('images/logo/7.png') }}" alt="" />
                            </div>
                            <div class="four columns">
                    ...
                    <ul class="slider3">
                        <li>
                            <div class="test animated slide">
                                ...
                                <h6>Pellentesque egestas ornare sagittis. Sed augue lorem, dignissim eget bibendum vitae,
                                    scelerisque eget justo. Duis tincidunt erat quam. Etiam placerat sapien elit. Class
                                    aptent taciti sociosqu ad litora torquent per conubia nostra.</h6>
                        ...
                        <li>
                            <div class="test">
                                <div class="icon-test">&#xf10e;</div>
                                <h6>Dignissim eget bibendum vitae, scelerisque eget justo. Duis tincidunt erat quam. Etiam
                                    placerat sapien elit. Class aptent taciti sociosqu ad litora torquent per conubia
                                    nostra, per inceptos himenaeos. Pellentesque egestas ornare sagittis.</h6>
    ...
    <div id="contact">
        ...
        <div class="footer">
            <div class="container">
                <div class="sixteen columns">
                    <a href="#home" class="scroll"><img src="{{ asset('images/logo.png') }}" alt="" /></a>
                </div>
                <div class="sixteen columns">
