<div id="sidebar">
    ...
    <hr>
    <ul>
        <li><a class="title" href="javascript:goTo('privateWealthManagement')">@lang('public.private wealth management')</a>
            <ul>
        ...
        <li><a class="title" href="javascript:goTo('corporateAdvisoryAndBanking')">@lang('public.corporate advisory & banking')</a>
            <ul>
        ...
        <li><a class=" title" href="javascript:goTo('privateEquity')">@lang('public.private equity')</a>
            <ul>
