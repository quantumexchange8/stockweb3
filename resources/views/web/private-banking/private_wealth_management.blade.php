        ...
        <div class="five columns">
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    ...
                    <p>@lang('public.private public.private wealth management caption 2')
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
            ...
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    ...
                    <p>@lang('public.private public.private wealth management caption 3')
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
            ...
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    ...
                    <p>@lang('public.private public.private wealth management caption 4')
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
        ...
        <div class="five columns">
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    ...
                    <p>@lang('public.private public.private wealth management caption 5')
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
            ...
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    ...
                    <p>@lang('public.private public.private wealth management caption 6')
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
            ...
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    ...
                    <p>@lang('public.private public.private wealth management caption 7')
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
