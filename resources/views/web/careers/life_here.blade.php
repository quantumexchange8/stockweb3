        ...
        <div class="five columns">
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    <h6 style="text-align: left;"><a href="javascript:goTo('ourCulture')">Our
                            Culture</a></h6>
                    <p>An entrepreneurial spirit and a collaborative environment that enables you to add value wherever
                        you can.
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
                        <div class="cl-effect-14"><a href="javascript:goTo('ourCulture')">read
                                more</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card" style="padding: 5px;">
                <div style="background-color: #DEDEDE; padding: 20px; height: 250px;">
                    <h6 style="text-align: left;"><a href="javascript:goTo('affinityNetworkCommunity')">Affinity Network
                            Community</a></h6>
                    <p>A global community of employee-led networks founded by and for diverse professionals.
                    </p>
                    <div class="clear"></div>
                    <div class="link-blog">
