...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <br>
        <p><strong>Client-Focused, Relationship-Driven</strong></p>
        <br>
        ...
        <br>
        <p><strong>Collaboration, Commitment, and Stewardship</strong></p>
        <br>
        <p>Our clients' reputation is our reputation, and nothing matters more. Our decision-making is
            ...
            agreements quickly. It’s a powerful combination of prudence and speed.</p>
        <br>
        <p><strong>Entrepreneurial Spirit</strong></p>
        <br>
        <p>We foster an entrepreneurial spirit and a collaborative environment that enables you to add
