...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <div class="five columns">
            <div class="card">
                <h6 class="card-title"><a href="javascript:goTo('undergraduateInternships')">@lang('public.undergraduate internships')</a></h6>
            ...
            <div class="card">
                <h6 class="card-title"><a href="javascript:goTo('experiencedProfessionals')">@lang('public.experienced professionals')</a></h6>
        ...
        <div class="five columns">
            <div class="card">
                <h6 class="card-title"><a href="javascript:goTo('entryLevelProfessionals')">@lang('public.entry level professionals')</a></h6>
            ...
            <div class="card">
                <h6 class="card-title"><a href="javascript:goTo('restart')">@lang('public.restart')@</a></h6>
