<div class="container breadcrumb">
    <div class="sixteen columns">
        <span>
            ...
            &nbsp;&nbsp;<strong>Undergraduate Internships</strong>
        </span>
    </div>
    <br><br>
    <hr>
...
<div class="container">
    ...
    <div class="eleven columns">
        <h2>Undergraduate Internships</h2>
        ...
        <p>Our internship programs are carefully designed to give you an immersive experience and an
            ...
            skills and knowledge to make a meaningful impact.</p>
        <p>Throughout the program, you will receive formal orientation to acquaint you with our company
            ...
            progress and make continuous improvements.</p>
        <br>
        ...
        <div style="padding-left: 30px;">
            ...
            <li>collaborative, entrepreneurial, energetic, and adaptable</li>
        </div>
        <br>
        <p><strong>US Program:</strong></p>
        <p>Our 10-week US internship is available to students in their junior year of undergraduate
            ...
            including Investor Services, Private Banking, Systems, and Administration.</p>
        <br>
        <p><strong>Europe Programs (Dublin, Krakow and Luxembourg):</strong></p>
        <p>In Dublin, we offer a full-time summer internship program which generally runs from June –
        ...
        <p>In Krakow, Poland, a variety of opportunities are available in our Investor Services
            ...
            Our internships are with flexible hours with a commitment of minimum 24 hours per week.</p>
        <p>In Luxembourg, we offer a full-time internship program lasting from 6 to 12 months in
