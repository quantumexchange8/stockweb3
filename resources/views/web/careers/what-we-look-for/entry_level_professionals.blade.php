...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <div style="padding-left: 30px;">
            <li>a desire to take on new challenges</li>
            <li>an entrepreneurial approach </li>
            <li>innovative thinking</li>
            <li>high integrity</li>
            <li>an ability to create and maintain valuable relationships</li>
            <li>a passion for helping others</li>
        </div>
        <br>
        <p>At Wingate, you have the opportunity to define your career path, and we have a strategy in
