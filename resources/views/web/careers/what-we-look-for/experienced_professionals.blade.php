<div class="container breadcrumb">
    <div class="sixteen columns">
        <span>
            ...
            &nbsp;&nbsp;<strong>@lang('public.experienced professionals')</strong>
        </span>
    </div>
    <br><br>
    <hr>
...
<div class="container">
    ...
    <div class="eleven columns">
        ...
        <p>At Vanward ("Vanward"), our global business strategy relies on attracting and retaining
            ...
            for over a decade.</p>
            <br>
        <p>Our Partners and senior leaders possess an average of 25 years of industry experience, and
        ...
        <p>At the executive level, success is defined by the ability to effectively lead winning teams
            and shape strategy. This means:</p>
        <div style="padding-left: 30px;">
            <li>solving complex problems by developing and integrating new ideas</li>
            <li>being the most trusted, valued, and differentiated partner to every client we serve</li>
            <li>speaking your mind, listening, and understanding views that differ from your own</li>
            <li>inspiring others through a collaborative mindset</li>
        </div>
        <br>
        <p>As soon as you walk through our doors, we provide you the opportunity to build relationships
            and the freedom to shape your career path.</p>
        </p>
    </div>
